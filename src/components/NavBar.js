    ...
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-between flex-wrap">
          <motion.a
            href="https://github.com/Omkar0301"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
          ...
          <motion.a
            href="https://www.linkedin.com/in/omkar-vaidya-6601631aa"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
          ...
          <motion.a
            href="https://www.instagram.com/vaidya_omkar03/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <button
            ...
            className={`w-6 ml-6 flex items-center justify-center rounded-full p-1 
