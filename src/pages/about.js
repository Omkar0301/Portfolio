...
const about = () => {
  return (
    <>
      <Head>
        <title>Omkar Vaidya | About Page</title>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 ">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                {` Hello, I'm `}
                <strong className="font-bold text-dark/75 dark:text-light">
                  Omkar Vaidya,
                </strong>
                {` a full stack developer specializing in ReactJS, NodeJS, MongoDB, ExpessJS, Nest Js and NextJS. 
